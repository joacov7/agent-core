...
/**
 * CoreStore in-memory (idéntico al de los otros adapters: las apps son
 * independientes y no dependen entre sí). Toda lectura filtra por `ctx.tenantId`
 * (aislamiento por tenant — en un marketplace, típicamente un tenant por vendedor).
 */
